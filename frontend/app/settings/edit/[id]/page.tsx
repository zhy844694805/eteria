...
import { ArrowLeftIcon, SaveIcon, Sparkles } from 'lucide-react'
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          {memorial.type === 'HUMAN' && (
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <p className="text-slate-600 mb-6">为 {memorial.subjectName} 创建数字生命，实现AI对话和语音合成功能</p>
